			...
			switch(mtk_msdc_host[0]->hw->clk_src)
				{
					case 0:
							...
							break;
					case 1:
							seq_printf(m, "MSDC0_CLK = 800MHZ,");
							break;
					case 2:
							seq_printf(m, "MSDC0_CLK = 400MHZ,");
							break;
					case 3:
							seq_printf(m, "MSDC0_CLK = 200MHZ,");
							break;
					case 4:
							seq_printf(m, "MSDC0_CLK = 182MHZ,");
							break;
					case 5:
							seq_printf(m, "MSDC0_CLK = 136MHZ,");
							break;
					case 6:
							seq_printf(m, "MSDC0_CLK = 156MHZ,");
							break;
					case 7:
							seq_printf(m, "MSDC0_CLK = 416MHZ,");
							break;
					case 8:
							seq_printf(m, "MSDC0_CLK = 48MHZ,");
							break;
					case 9:
							seq_printf(m, "MSDC0_CLK = 91MHZ,");
							break;
					case 10:
							seq_printf(m, "MSDC0_CLK = 624MHZ,");
							break;
			}
	}
	...
	if (mtk_msdc_host[1]) {
					switch(mtk_msdc_host[1]->hw->clk_src)
				{
					...
					case 1:
							...
							break;
					case 2:
							seq_printf(m, "MSDC1_CLK = 200MHZ\n");
							break;
					case 3:
							seq_printf(m, "MSDC1_CLK = 182MHZ\n");
							break;
					case 4:
							seq_printf(m, "MSDC1_CLK = 136MHZ\n");
							break;
					case 5:
							seq_printf(m, "MSDC1_CLK = 156MHZ\n");
							break;
					case 6:
							seq_printf(m, "MSDC1_CLK = 48MHZ\n");
							break;
					case 7:
							seq_printf(m, "MSDC1_CLK = 91MHZ\n");
							break;
		    }
	}
	return 0;
