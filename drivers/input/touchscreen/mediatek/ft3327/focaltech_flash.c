...
static unsigned char CTPM_HLT_FW[] = {
	#include "FT3x27_HLT_V10_D02_20161130_app.i"
};

static unsigned char CTPM_YKL_FW[] = {
	#include "FT3x27_YKL_V12_20160120_app.i"
};
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	{
		CTPM_FW = CTPM_HLT_FW;
		sw_fw_len = sizeof(CTPM_HLT_FW);
	}
	else if(vend_id == 0x07)
	{
		CTPM_FW = CTPM_YKL_FW;
		sw_fw_len = sizeof(CTPM_YKL_FW);
	}
	else
	{
		CTPM_FW = NULL;
	...
	if ((uc_tp_fm_ver < uc_host_fm_ver )  &&   CTPM_FW!=NULL  ||uc_tp_fm_ver > RGK_SAMPLE_YKL_VERSION  || uc_tp_fm_ver <= 0 )
//if (sw_fw_len !=0 && (uc_tp_fm_ver < uc_host_fm_ver ||   uc_tp_fm_ver ==0  ))
	//if (uc_tp_fm_ver != RGK_SAMPLE_HELITAI_VERSION ) 
