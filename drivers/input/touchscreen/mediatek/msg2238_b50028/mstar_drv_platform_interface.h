...
extern signed int /*__devinit*/ MsDrvInterfaceTouchDeviceProbe(struct i2c_client *pClient, const struct i2c_device_id *pDeviceId);
extern signed int /*__devexit*/ MsDrvInterfaceTouchDeviceRemove(struct i2c_client *pClient);
...
extern void MsDrvInterfaceTouchDeviceSetIicDataRate(struct i2c_client *pClient, unsigned int nIicDataRate);
