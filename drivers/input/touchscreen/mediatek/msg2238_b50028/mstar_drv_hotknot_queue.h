...
extern int PushQueue(unsigned char * pBuf, unsigned short nLength);
extern int PopQueue(unsigned char * pBuf, unsigned short nLength);
extern int ShowQueue(unsigned char * pBuf, unsigned short nLength);    //just show data, not fetch data
extern void ShowAllQueue(unsigned char * pBuf, unsigned short * pFront, unsigned short * pRear);    //just show data, not fetch data
