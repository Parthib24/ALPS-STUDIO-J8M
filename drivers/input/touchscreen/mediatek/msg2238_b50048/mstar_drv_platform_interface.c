...
static unsigned char flag_suspend = 0;
#endif //CONFIG_ENABLE_PROXIMITY_DETECTION

#ifdef CONFIG_ENABLE_GLOVE_MODE
extern unsigned char g_IsEnableGloveMode;
...
extern unsigned char g_ForceUpdate;
...
#ifdef CONFIG_ENABLE_HOTKNOT
static unsigned char _gAMStartCmd[4] = {HOTKNOT_SEND, ADAPTIVEMOD_BEGIN, 0, 0};
#endif //CONFIG_ENABLE_HOTKNOT
...
signed int /*__devinit*/ MsDrvInterfaceTouchDeviceProbe(struct i2c_client *pClient, const struct i2c_device_id *pDeviceId)
{
...
signed int /*__devexit*/ MsDrvInterfaceTouchDeviceRemove(struct i2c_client *pClient)
{
    DBG("*** %s() ***\n", __func__);
...
void MsDrvInterfaceTouchDeviceSetIicDataRate(struct i2c_client *pClient, unsigned int nIicDataRate)
{
    DBG("*** %s() ***\n", __func__);
