...
extern void DrvPlatformLyrFingerTouchPressed(signed int nX, signed int nY, signed int nPressure, signed int nId);
extern void DrvPlatformLyrFingerTouchReleased(signed int nX, signed int nY, signed int nId);
extern signed int DrvPlatformLyrInputDeviceInitialize(struct i2c_client *pClient);
extern void DrvPlatformLyrSetIicDataRate(struct i2c_client *pClient, unsigned int nIicDataRate);
...
extern signed int DrvPlatformLyrTouchDeviceRegisterFingerTouchInterruptHandler(void);
extern signed int DrvPlatformLyrTouchDeviceRemove(struct i2c_client *pClient);
extern signed int DrvPlatformLyrTouchDeviceRequestGPIO(struct i2c_client *pClient);        
...
#elif defined(CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM)
extern int DrvPlatformLyrTpPsOperate(void* pSelf, unsigned int nCommand, void* pBuffIn, int nSizeIn, void* pBuffOut, int nSizeOut, int* pActualOut);
#endif
#endif //CONFIG_ENABLE_PROXIMITY_DETECTION
