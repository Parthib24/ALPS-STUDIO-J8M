...
#pragma message("bbbbbbbbbbbb______________________________")
/*
 * Note.
...
extern unsigned char TOUCH_DRIVER_DEBUG_LOG_LEVEL;
...
extern unsigned char DrvCommonCalculateCheckSum(unsigned char *pMsg, unsigned int nLength);
extern unsigned int DrvCommonConvertCharToHexDigit(char *pCh, unsigned int nLength);
extern unsigned int DrvCommonCrcDoReflect(unsigned int nRef, signed char nCh);
extern unsigned int DrvCommonCrcGetValue(unsigned int nText, unsigned int nPrevCRC);
extern void DrvCommonCrcInitTable(void);
extern void DrvCommonReadFile(char *pFilePath, unsigned char *pBuf, unsigned short nLength);
