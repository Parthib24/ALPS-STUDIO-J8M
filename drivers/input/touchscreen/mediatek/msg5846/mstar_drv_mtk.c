...
if(showflag == 1)
{
		...
		len=sprintf(tp_info,"TP IC:%s,TP MODULE:%s,TP I2C ADR:0x%x,SW FirmWare:%x.%x,Sample FirmWare:%x.%x","MSG5846","DIJIN",client->addr,pMajor,pMinor,SAMPLE_FWVER_DJ_MAJOR,SAMPLE_FWVER_DJ_MINOR);
