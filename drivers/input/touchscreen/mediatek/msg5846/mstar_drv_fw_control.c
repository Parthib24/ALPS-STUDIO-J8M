...
#include "msg28xx_dj_v12_update.h" // for MSG28xx
...
static void _DrvFwCtrlUpdateFirmwareBySwIdDoWork(struct work_struct *pWork)
{
	...
	int len;
		...
		len=sprintf(tp_info,"TP IC:%s,TP MODULE:%s,TP I2C ADR:0x%x,SW FirmWare:%x.%x,Sample FirmWare:%x.%x","MSG5846","DIJIN",0x26,pMajor,pMinor,SAMPLE_FWVER_DJ_MAJOR,SAMPLE_FWVER_DJ_MINOR );
