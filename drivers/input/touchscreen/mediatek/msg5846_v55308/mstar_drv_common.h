...
#define DEVICE_DRIVER_RELEASE_VERSION   ("5.1.0.0")
 ...
 * By default, this compile option is disabled.
 */
//#define CONFIG_ENABLE_ESD_PROTECTION //rl open//calm: close for touch event not release by chance.
...
#define ONCELL_HD_OUTCELL_FHD_TOUCH_SCREEN 


#ifdef ONCELL_HD_OUTCELL_FHD_TOUCH_SCREEN

extern u16 TOUCH_SCREEN_X_MAX ;
extern u16 TOUCH_SCREEN_Y_MAX ;

#define TOUCH_SCREEN_HD_X_MAX   (720)  //LCD_WIDTH
#define TOUCH_SCREEN_HD_Y_MAX   (1280) //LCD_HEIGHT
#define TOUCH_SCREEN_FHD_X_MAX   (1080)  //LCD_WIDTH
#define TOUCH_SCREEN_FHD_Y_MAX   (1920) //LCD_HEIGHT
