...
static unsigned char _gTestFailChannel[MAX_CHANNEL_NUM] = {0};
...
static signed short _gRawData1[MAX_CHANNEL_NUM] = {0};
static signed short _gRawData2[MAX_CHANNEL_NUM] = {0};
static signed short _gRawData3[MAX_CHANNEL_NUM] = {0};
static signed short _gRawData4[MAX_CHANNEL_NUM] = {0};
static signed char _gDataFlag1[MAX_CHANNEL_NUM] = {0};
static signed char _gDataFlag2[MAX_CHANNEL_NUM] = {0};
static signed char _gDataFlag3[MAX_CHANNEL_NUM] = {0};
static signed char _gDataFlag4[MAX_CHANNEL_NUM] = {0};

static unsigned char _gItoTestKeyNum = 0;
static unsigned char _gItoTestDummyNum = 0;
static unsigned char _gItoTestTriangleNum = 0;
static unsigned char _gIsEnable2R = 0;


static unsigned char _gLTP = 1;	

// _gOpen1~_gOpen3 are for MSG21XXA
static unsigned short *_gOpen1 = NULL;
static unsigned short *_gOpen1B = NULL;
static unsigned short *_gOpen2 = NULL;
static unsigned short *_gOpen2B = NULL;
static unsigned short *_gOpen3 = NULL;

// _gShort_1~_gShort_4 are for MSG21XXA
static unsigned short *_gShort_1 = NULL;
static unsigned short *_gShort_2 = NULL;
static unsigned short *_gShort_3 = NULL;

// _gShort_1_GPO~_gShort_4_GPO are for MSG21XXA
static unsigned short *_gShort_1_GPO = NULL;
static unsigned short *_gShort_2_GPO = NULL;
static unsigned short *_gShort_3_GPO = NULL;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static unsigned short *_gShort_4 = NULL;
static unsigned short *_gShort_4_GPO = NULL;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE


static unsigned char _gIsOldFirmwareVersion = 0;

// _gOpenRIU1~_gOpenRIU3 are for MSG22XX
static unsigned int *_gOpenRIU1 = NULL;
static unsigned int *_gOpenRIU2 = NULL;
static unsigned int *_gOpenRIU3 = NULL;

// _gShort_RIU1~_gShort_RIU4 are for MSG22XX
static unsigned int *_gShort_RIU1 = NULL;
static unsigned int *_gShort_RIU2 = NULL;
static unsigned int *_gShort_RIU3 = NULL;

// _gOpenSubFrameNum1~_gShortSubFrameNum4 are for MSG22XX
static unsigned char _gOpenSubFrameNum1 = 0;
static unsigned char _gOpenSubFrameNum2 = 0;
static unsigned char _gOpenSubFrameNum3 = 0;
static unsigned char _gShortSubFrameNum1 = 0;
static unsigned char _gShortSubFrameNum2 = 0;
static unsigned char _gShortSubFrameNum3 = 0;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static unsigned int *_gShort_RIU4 = NULL;
static unsigned char _gShortSubFrameNum4 = 0;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE


static unsigned char *_gMAP1 = NULL;
static unsigned char *_gMAP2 = NULL;
static unsigned char *_gMAP3 = NULL;
static unsigned char *_gMAP40_1 = NULL;
static unsigned char *_gMAP40_2 = NULL;
static unsigned char *_gMAP41_1 = NULL;
static unsigned char *_gMAP41_2 = NULL;

static unsigned char *_gSHORT_MAP1 = NULL;
static unsigned char *_gSHORT_MAP2 = NULL;
static unsigned char *_gSHORT_MAP3 = NULL;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static unsigned char *_gMAP40_3 = NULL;
static unsigned char *_gMAP40_4 = NULL;
static unsigned char *_gMAP41_3 = NULL;
static unsigned char *_gMAP41_4 = NULL;

static unsigned char *_gSHORT_MAP4 = NULL;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
...
static unsigned short _DrvMpTestItoTestGetTpType(void)
{
...
static unsigned short _DrvMpTestItoTestChooseTpType(void)
{
...
static unsigned short _DrvMpTestItoTestGetNum(void)
{
    unsigned int i;
    unsigned short nSensorNum = 0;
    unsigned short nRegVal1, nRegVal2;
...
static void _DrvMpTestItoOpenTestSetV(unsigned char nEnable, unsigned char nPrs)	
{
    unsigned short nRegVal;        
...
static unsigned short _DrvMpTestItoTestMsg21xxaGetDataOut(signed short *pRawData)
{
    unsigned int i;
    unsigned short szRawData[MAX_CHANNEL_NUM] = {0};
    unsigned short nSensorNum;
    unsigned short nRegInt;
    unsigned char  szDbBusTxData[8] = {0};
    unsigned char  szDbBusRxData[MAX_CHANNEL_NUM*2] = {0};
    ...
    RegSet16BitValue((0x3d<<8) | (REG_INTR_FIQ_MASK<<1), (nRegInt & (unsigned short)(~FIQ_E_FRAME_READY_MASK))); 
    ...
    for (i = 0; i < nSensorNum; i ++)
    {
        ...
        pRawData[i] = (signed short)szRawData[i];
    }
    
    return nSensorNum;
}

static void _DrvMpTestItoTestMsg21xxaSendDataIn(unsigned char nStep)
{
    unsigned int	i;
    unsigned short *pType = NULL;        
    unsigned char 	szDbBusTxData[512] = {0};
...
static void _DrvMpTestItoOpenTestMsg21xxaSetC(unsigned char nCSubStep)
{
    unsigned int i;
    unsigned char szDbBusTxData[MAX_CHANNEL_NUM+3];
    unsigned char nHighLevelCSub = 0;
    unsigned char nCSubNew;
...
static void _DrvMpTestItoOpenTestMsg21xxaFirst(unsigned char nItemId, signed short *pRawData, signed char *pDataFlag)		
{
    unsigned int i, j;
    signed short szTmpRawData[MAX_CHANNEL_NUM] = {0};
    unsigned short	nRegVal;
    unsigned char  nLoop;
    unsigned char  nSensorNum1 = 0, nSensorNum2 = 0, nTotalSensor = 0;
    unsigned char 	*pMapping = NULL;
...
static void _DrvMpTestItoShortTestChangeGPOSetting(unsigned char nItemId)
{
    unsigned char szDbBusTxData[3+GPO_SETTING_SIZE*2] = {0};
    unsigned short szGPOSetting[3] = {0};
    unsigned int i;
...
static void _DrvMpTestItoShortTestChangeRmodeSetting(unsigned char nMode)
{
    unsigned char szDbBusTxData[6] = {0};
...
static void _DrvMpTestItoShortTestMsg21xxaFirst(unsigned char nItemId, signed short *pRawData, signed char *pDataFlag)		
{
    unsigned int i;
    signed short szTmpRawData[MAX_CHANNEL_NUM] = {0};
    signed short szTmpRawData2[MAX_CHANNEL_NUM] = {0};
    unsigned char  nSensorNum, nSensorNum2, nNumOfSensorMapping1, nNumOfSensorMapping2, nSensorCount = 0;
    unsigned char 	*pMapping = NULL;
...
static unsigned short _DrvMpTestItoTestMsg22xxGetDataOut(signed short *pRawData, unsigned short nSubFrameNum)
{
    unsigned int i;
    unsigned short szRawData[MAX_CHANNEL_NUM*2] = {0};
    unsigned short nRegInt = 0x0000;
    unsigned short nSize = nSubFrameNum * 4;  // 1SF 4AFE
    unsigned char  szDbBusTxData[8] = {0};
    unsigned char  szDbBusRxData[MAX_CHANNEL_NUM*4] = {0};
...
static void _DrvMpTestItoTestMsg22xxSendDataIn(unsigned char nStep, unsigned short nRiuWriteLength)
{
    unsigned int	i;
    ...
    {
        RegSet16BitValue(0x118A, (unsigned short)(pType[i]));
        RegSet16BitValue(0x118C, (unsigned short)(pType[i] >> 16));
    }
}

static void _DrvMpTestItoTestMsg22xxSetC(unsigned char nCSubStep)
{
    unsigned int i;
    unsigned short nRegVal;
    unsigned int nCSubNew; 
...
static void _DrvMpTestItoTestMsg22xxGetChargeDumpTime(unsigned short nMode, unsigned short *pChargeTime, unsigned short *pDumpTime)
{
    unsigned short nChargeTime = 0, nDumpTime = 0;
    unsigned short nMinChargeTime = 0xFFFF, nMinDumpTime = 0xFFFF, nMaxChargeTime = 0x0000, nMaxDumpTime = 0x0000;
...
static void _DrvMpTestItoOpenTestMsg22xxFirst(unsigned char nItemId, signed short *pRawData, signed char *pDataFlag)		
{
    unsigned int i;
    signed short szTmpRawData[MAX_CHANNEL_NUM*2] = {0};
    unsigned short nSubFrameNum = 0;
    unsigned short nChargeTime, nDumpTime;
    unsigned char 	*pMapping = NULL;
...
static void _DrvMpTestItoShortTestMsg22xxFirst(unsigned char nItemId, signed short *pRawData, signed char *pDataFlag)		
{
    unsigned int i, j;
    signed short szIIR1[MAX_SUBFRAME_NUM*MAX_AFE_NUM] = {32767};
    signed short szIIR2[MAX_SUBFRAME_NUM*MAX_AFE_NUM] = {32767};
    signed short szIIRTmp[MAX_SUBFRAME_NUM*MAX_AFE_NUM] = {32767};
    unsigned short nSensorNum = 0, nSubFrameNum = 0;
    unsigned char 	*pMapping = NULL;
...
static unsigned char _DrvMpTestMsg22xxCheckFirmwareVersion(void) // Only MSG22XX support platform firmware version
{
    unsigned int i;
    signed int nDiff;
    unsigned short nRegData1, nRegData2;
    unsigned char szDbBusRxData[12] = {0};
    unsigned char szCompareFwVersion[10] = {0x56, 0x30, 0x31, 0x2E, 0x30, 0x30, 0x35, 0x2E, 0x30, 0x32}; //{'V', '0', '1', '.', '0', '0', '5', '.', '0', '2'}
    unsigned char nIsOldFirmwareVersion = 0;
...
static ItoTestResult_e _DrvMpTestItoOpenTestSecond(unsigned char nItemId)
{
    ItoTestResult_e nRetVal = ITO_TEST_OK;
    unsigned int i;
    signed int nTmpRawDataJg1 = 0;
    signed int nTmpRawDataJg2 = 0;
    signed int nTmpJgAvgThMax1 = 0;
    signed int nTmpJgAvgThMin1 = 0;
    signed int nTmpJgAvgThMax2 = 0;
    signed int nTmpJgAvgThMin2 = 0;
...
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
static ItoTestResult_e _DrvMpTestItoOpenTestSecond2r(unsigned char nItemId)
{
    ItoTestResult_e nRetVal = ITO_TEST_OK;
    unsigned int i;
    signed int nTmpRawDataJg1 = 0;
    signed int nTmpRawDataJg2 = 0;
    signed int nTmpRawDataJg3 = 0;
    signed int nTmpRawDataJg4 = 0;
    signed int nTmpJgAvgThMax1 = 0;
    signed int nTmpJgAvgThMin1 = 0;
    signed int nTmpJgAvgThMax2 = 0;
    signed int nTmpJgAvgThMin2 = 0;
    signed int nTmpJgAvgThMax3 = 0;
    signed int nTmpJgAvgThMin3 = 0;
    signed int nTmpJgAvgThMax4 = 0;
    signed int nTmpJgAvgThMin4 = 0;
...
static ItoTestResult_e _DrvMpTestItoShortTestSecond(unsigned char nItemId)
{
    ItoTestResult_e nRetVal = ITO_TEST_OK;
    unsigned int i;
    unsigned char nSensorCount = 0;
    unsigned char nNumOfSensorMapping1 = 0, nNumOfSensorMapping2 = 0;
...
{
    unsigned int i;
    unsigned char nHighByte, nLowByte;
