...
extern unsigned char g_GestureWakeupFlag;
...
unsigned char DrvIcFwLyrGetChipType(void)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrGetCustomerFirmwareVersion(unsigned short *pMajor, unsigned short *pMinor, unsigned char **ppVersion)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrGetPlatformFirmwareVersion(unsigned char **ppVersion)
{
//    DBG("*** %s() ***\n", __func__);
...
signed int DrvIcFwLyrUpdateFirmware(unsigned char szFwData[][1024], EmemType_e eEmemType)
{
//    DBG("*** %s() ***\n", __func__);
...
signed int DrvIcFwLyrUpdateFirmwareBySdCard(const char *pFilePath)
{
//    DBG("*** %s() ***\n", __func__);
...
unsigned int DrvIcFwLyrIsRegisterFingerTouchInterruptHandler(void)
{
    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrHandleFingerTouch(unsigned char *pPacket, unsigned short nLength)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrOpenGestureWakeup(unsigned int *pWakeupMode)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrOpenGestureDebugMode(unsigned char nGestureFlag)
{
//    DBG("*** %s() ***\n", __func__);
...
unsigned int DrvIcFwLyrReadDQMemValue(unsigned short nAddr)
{
//	  DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrWriteDQMemValue(unsigned short nAddr, unsigned int nData)
{
//	  DBG("*** %s() ***\n", __func__);
...
unsigned short DrvIcFwLyrGetFirmwareMode(void)
{
//    DBG("*** %s() ***\n", __func__);
...
unsigned short DrvIcFwLyrChangeFirmwareMode(unsigned short nMode)
{
//    DBG("*** %s() ***\n", __func__);
...
signed int DrvIcFwLyrGetMpTestResult(void)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrGetMpTestFailChannel(ItoTestMode_e eItoTestMode, unsigned char *pFailChannel, unsigned int *pFailChannelCount)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrGetMpTestDataLog(ItoTestMode_e eItoTestMode, unsigned char *pDataLog, unsigned int *pLength)
{
//    DBG("*** %s() ***\n", __func__);
...
#if defined(CONFIG_ENABLE_TOUCH_DRIVER_FOR_MUTUAL_IC)
void DrvIcFwLyrGetTouchPacketAddress(unsigned short *pDataAddress, unsigned short *pFlagAddress)
{
//    DBG("*** %s() ***\n", __func__);
...
signed int DrvIcFwLyrEnableProximity(void)
{
//    DBG("*** %s() ***\n", __func__);
...
signed int DrvIcFwLyrDisableProximity(void)
{
//    DBG("*** %s() ***\n", __func__);
...
void DrvIcFwLyrGetGloveInfo(unsigned char *pGloveMode)
{
//    DBG("*** %s() ***\n", __func__);
