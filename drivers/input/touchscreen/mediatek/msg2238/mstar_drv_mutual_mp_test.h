...
extern void DrvMpTestGetTestDataLog(ItoTestMode_e eItoTestMode, unsigned char *pDataLog, unsigned int *pLength);
extern void DrvMpTestGetTestFailChannel(ItoTestMode_e eItoTestMode, unsigned char *pFailChannel, unsigned int *pFailChannelCount);
extern signed int DrvMpTestGetTestResult(void);
