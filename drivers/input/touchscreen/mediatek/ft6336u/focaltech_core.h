...
#define RGK_SAMPLE_VERSION_DIJING               0x11
#define RGK_SAMPLE_VERSION_YUSHUN             0x11
...
#define RGK_SAMPLE_HELITAI_VERSION 0x11

#define RGK_SAMPLE_YUSHUN_VERSION 0x11
...
extern u8 fts_ctpm_update(struct i2c_client *client);
extern int fts_ctpm_auto_upgrade(void *data);
