...
static unsigned char CTPM_FW[] = {
	...
	//#include "HLT-V52516_FT3427_V02_D01_20161222_app.i"
	#include "HLT-V52516_FT3427_V03_D01_20161226_app.i"
};
//xiancai
...
static unsigned char CTPM_FW_VENDOR_2[] = {
	//#include "HQ_AL828_Y53_Booyi0xa6_Ver02_20160729_app.i"
};
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	int ret11 = fts_read_reg(client, FTS_REG_FW_VER, &uc_tp_fm_ver);
	int ret1111  = fts_read_reg(client, FTS_REG_VENDOR_ID, &uc_tp_vendor_id);
