...
#define TPD_AUTO_UPGRADE    //xiancai
...
#define FTS_Vendor_1_ID     0x82 //hlt    xiancai
#define FTS_Vendor_2_ID     0x07 //ykl    xiancai
...
//#endif
extern struct i2c_client *i2c_client;      //xiancai
