...
static const struct i2c_device_id ft5x0x_tpd_id[] = {{"ft3427", 0}, {} };
static const struct of_device_id ft5x0x_dt_match[] = {
	{.compatible = "mediatek,cap_touch"},
	//{.compatible = "malata,cap_touch1"},
	{},
};
...
static int tpd_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	printk("tpd_probe start chengzhou \n");
	int retval = TPD_OK;
	u8 report_rate = 0;
	int reset_count = 0;
	char data;
	...
	if(NULL == client)
	{
		TPD_DMESG("mtk_tpd: tpd_probe ft3427 i2c client is NULL! \n");
		return -1;
	}
	if(NULL != client)
	{
		TPD_DMESG("mtk_tpd: tpd_probe ft3427 i2c client is OK! \n");
	}
#endif
	i2c_client = client;
	...
	TPD_DMESG("mtk_tpd: tpd_probe ft3427\n");
...
reset_proc:
	...
	err = fts_read_reg(i2c_client, 0x00, &data);
		printk("tpd_probe 55555 chengzhou \n");
...
#endif
	printk("tpd_probe end chengzhou \n");
	return 0;
}
...
static int tpd_local_init(void)
{
	...
	TPD_DMESG("Focaltech FT5x0x I2C Touchscreen Driver2...\n");
     /* tpd_load_status = 1; */
	if (tpd_dts_data.use_tpd_button) {
		tpd_button_setting(tpd_dts_data.tpd_key_num, tpd_dts_data.tpd_key_local,
		tpd_dts_data.tpd_key_dim_local);
	}
	TPD_DMESG("Focaltech FT5x0x I2C Touchscreen Driver3...\n");
#if (defined(TPD_WARP_START) && defined(TPD_WARP_END))
	TPD_DO_WARP = 1;
	memcpy(tpd_wb_start, tpd_wb_start_local, TPD_WARP_CNT * 4);
	memcpy(tpd_wb_end, tpd_wb_start_local, TPD_WARP_CNT * 4);
#endif
TPD_DMESG("Focaltech FT5x0x I2C Touchscreen Driver4...\n");
#if (defined(CONFIG_TPD_HAVE_CALIBRATION) && !defined(CONFIG_TPD_CUSTOM_CALIBRATION))
...
#endif
TPD_DMESG("Focaltech FT5x0x I2C Touchscreen Driver5...\n");
	TPD_DMESG("end %s, %d\n", __func__, __LINE__);
	tpd_type_cap = 1;
