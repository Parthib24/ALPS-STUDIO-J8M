...
#elif defined(CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM)
#ifndef CONFIG_TP_MSG2238_COMPATIBLE
#define BUTTON_W (100)
#define BUTTON_H (100)
#endif

#ifdef CONFIG_TP_MSG2238_COMPATIBLE
int g_TpVirtualKeyDimLocal[MAX_KEY_NUM][4] = {{BUTTON_W/2*1,854+BUTTON_H/2,BUTTON_W,BUTTON_H},
                                                    {BUTTON_W/2*3,854+BUTTON_H/2,BUTTON_W,BUTTON_H},
                                                    {BUTTON_W/2*5,854+BUTTON_H/2,BUTTON_W,BUTTON_H},
                                                    {BUTTON_W/2*7,854+BUTTON_H/2,BUTTON_W,BUTTON_H}};
...
void DrvPlatformLyrFingerTouchPressed(s32 nX, s32 nY, s32 nPressure, s32 nId)
{
    ...
    input_report_abs(g_InputDevice, ABS_MT_POSITION_X, nX);//nX //nX*720/480
    input_report_abs(g_InputDevice, ABS_MT_POSITION_Y, nY);//nY //nY*1280/854
...
//    DBG(&g_I2cClient->dev, "nId=%d, nX=%d, nY=%d\n", nId, nX, nY); // TODO : add for debug
	...
	//calm: remove TRACKING_ID to support 2 point touch function
