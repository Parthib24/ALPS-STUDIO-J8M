...
#ifdef CONFIG_TP_MSG2238_COMPATIBLE
int TOUCH_SCREEN_X_MAX = 720; //default 720
int TOUCH_SCREEN_Y_MAX = 1280; //default 1280
#endif
/*=============================================================*/
...
#ifdef CONFIG_TP_MSG2238_COMPATIBLE
	TOUCH_SCREEN_X_MAX = primary_display_get_width();
	TOUCH_SCREEN_Y_MAX = primary_display_get_height();
	
	if(1280 == TOUCH_SCREEN_Y_MAX)
	{
		for(i = 0; i<MAX_KEY_NUM; i++)
		{
			g_TpVirtualKeyDimLocal[i][2] = TOUCH_SCREEN_Y_MAX+BUTTON_H/2;
		}
	}
#endif	
