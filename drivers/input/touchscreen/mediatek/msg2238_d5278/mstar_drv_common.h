 ...
 * This compile option is used for MTK platform only.
 * By default, this compile option is disabled.
 *///calm: open to support apk fireware update
 ...
 * By default, this compile option is disabled.
 */ //calm d527x open for tp psensor
#ifdef CONFIG_TOUCHSCREEN_MTK_MSG2238_PROXIMITY
