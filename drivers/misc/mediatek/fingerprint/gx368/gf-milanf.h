...
#ifdef FINGERPRINT_GX368_USING_32_BIT
...
#define gf_debug(level, fmt, args...) do{ \
	...
	printk(KERN_ERR"GF368M "fmt"\n", ##args); \
    } \
}while(0)
#define gf_error(fmt,arg...)          printk("<<GF368M_error>> "fmt"\n",##arg)  

#define FUNC_ENTRY()  gf_debug(FLOW_DEBUG, "GF368M:%s, entry\n", __func__)
#define FUNC_EXIT()  gf_debug(FLOW_DEBUG,"GF368M:%s, exit\n", __func__)
#endif
