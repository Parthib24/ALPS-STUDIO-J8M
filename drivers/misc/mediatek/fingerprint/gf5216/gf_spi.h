...
extern int gf_power_on(struct gf_dev *pdev);
extern int gf_power_off(struct gf_dev *pdev);
extern int gf_irq_num(struct gf_dev *pdev);
extern int gf_hw_reset(struct gf_dev *pdev, unsigned int delay_ms);
