...
#define  sw_dbg(fmt, args...)     do{if(1){  printk("sunwave: " _DRV_TAG_ " %d " fmt " \n",__LINE__, ##args);}}while(0)
#define  sw_info(fmt, args...)    do{printk(KERN_ERR"sunwave: " _DRV_TAG_ " %d " fmt " \n",__LINE__, ##args);}while(0)
...
extern int mt6797_pinctrl_realease(struct spi_device**    spi);
