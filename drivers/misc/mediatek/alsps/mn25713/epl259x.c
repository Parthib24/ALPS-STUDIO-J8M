...
static void initial_global_variable(struct i2c_client *client, struct epl_sensor_priv *obj)
{
    ...
    epl_sensor.als.report_type = CMC_BIT_TABLE;//CMC_BIT_RAW; //CMC_BIT_RAW; //CMC_BIT_DYN_INT;
...
static void epl_sensor_print_command(void)
{
#if 0
	unsigned int cmd;
	

	cmd = ALSPS_SET_PS_MODE;
	APS_ERR("[%s] ALSPS_SET_PS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_MODE;
	APS_ERR("[%s] ALSPS_GET_PS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_DATA;
	APS_ERR("[%s] ALSPS_GET_PS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_RAW_DATA;
	APS_ERR("[%s] ALSPS_GET_PS_RAW_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_SET_ALS_MODE;
	APS_ERR("[%s] ALSPS_SET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_MODE;
	APS_ERR("[%s] ALSPS_GET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_DATA;
	APS_ERR("[%s] ALSPS_GET_ALS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_RAW_DATA;
	APS_ERR("[%s] ALSPS_GET_ALS_RAW_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_TEST_RESULT;
	APS_ERR("[%s] ALSPS_GET_PS_TEST_RESULT cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_TEST_RESULT;
	APS_ERR("[%s] ALSPS_GET_ALS_TEST_RESULT cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_THRESHOLD_HIGH;
	APS_ERR("[%s] ALSPS_GET_PS_THRESHOLD_HIGH cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_PS_THRESHOLD_LOW;
	APS_ERR("[%s] ALSPS_GET_PS_THRESHOLD_LOW cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_THRESHOLD_HIGH;
	APS_ERR("[%s] ALSPS_GET_ALS_THRESHOLD_HIGH cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_GET_ALS_THRESHOLD_LOW;
	APS_ERR("[%s] ALSPS_GET_ALS_THRESHOLD_LOW cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_IOCTL_CLR_CALI;
	APS_ERR("[%s] ALSPS_IOCTL_CLR_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_IOCTL_GET_CALI;
	APS_ERR("[%s] ALSPS_IOCTL_GET_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_IOCTL_SET_CALI;
	APS_ERR("[%s] ALSPS_IOCTL_SET_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_SET_PS_THRESHOLD;
	APS_ERR("[%s] ALSPS_SET_PS_THRESHOLD cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = ALSPS_SET_ALS_THRESHOLD;
	APS_ERR("[%s] ALSPS_SET_ALS_THRESHOLD cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = AAL_SET_ALS_MODE;
	APS_ERR("[%s] AAL_SET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = AAL_GET_ALS_MODE;
	APS_ERR("[%s] AAL_SET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = AAL_GET_ALS_DATA;
	APS_ERR("[%s] AAL_GET_ALS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
#ifdef CONFIG_COMPAT
	cmd = COMPAT_ALSPS_SET_PS_MODE;
	APS_ERR("[%s] COMPAT_ALSPS_SET_PS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_MODE;
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_DATA;
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_RAW_DATA;
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_RAW_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_SET_ALS_MODE;
	APS_ERR("[%s] COMPAT_ALSPS_SET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_MODE;
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_DATA;
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_RAW_DATA;
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_RAW_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_TEST_RESULT;		
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_TEST_RESULT cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_TEST_RESULT;	
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_TEST_RESULT cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_THRESHOLD_HIGH;
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_THRESHOLD_HIGH cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_PS_THRESHOLD_LOW;
	APS_ERR("[%s] COMPAT_ALSPS_GET_PS_THRESHOLD_LOW cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_THRESHOLD_HIGH;	
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_THRESHOLD_HIGH cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_GET_ALS_THRESHOLD_LOW;
	APS_ERR("[%s] COMPAT_ALSPS_GET_ALS_THRESHOLD_LOW cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_IOCTL_CLR_CALI;
	APS_ERR("[%s] COMPAT_ALSPS_IOCTL_CLR_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_IOCTL_GET_CALI;
	APS_ERR("[%s] COMPAT_ALSPS_IOCTL_GET_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_IOCTL_SET_CALI;
	APS_ERR("[%s] COMPAT_ALSPS_IOCTL_SET_CALI cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_SET_PS_THRESHOLD;
	APS_ERR("[%s] COMPAT_ALSPS_SET_PS_THRESHOLD cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_ALSPS_SET_ALS_THRESHOLD;
	APS_ERR("[%s] COMPAT_ALSPS_SET_ALS_THRESHOLD cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_AAL_SET_ALS_MODE;
	APS_ERR("[%s] COMPAT_AAL_SET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_AAL_GET_ALS_MODE;
	APS_ERR("[%s] COMPAT_AAL_GET_ALS_MODE cmd = 0x%04x\n", __FUNCTION__, cmd);
	cmd = COMPAT_AAL_GET_ALS_DATA;
	APS_ERR("[%s] COMPAT_AAL_GET_ALS_DATA cmd = 0x%04x\n", __FUNCTION__, cmd);
#endif
#endif
}
