...
void pmic_HQA_Voltage_adjust(int nAdjust)
{
	...
	case 4:		/*NV*/
		...
		pmic_config_interface(MT6328_VCORE1_CON12, 0x58, 0x7F, 0);	/* 1.15V */
#endif
//add by xuliu for memmory 08EMCP08_NL3DT227 2017-04-11 start
		pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x0F, 0xF, 8);	/* -0.02V (1.22V) */ //0x1
//add by xuliu for memmory 08EMCP08_NL3DT227 2017-04-11 end
		pr_warn("========== NV ==========\r\n");
		break;
	default:	/*NV*/
#if defined(CONFIG_ARCH_MT6753)
