...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.PS=LCM_PACKED_PS_24BIT_RGB888;
		...
		params->dsi.horizontal_frontporch				=  120;//90
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xA1,1,{0x1B}}, //0x1F              //VP251
	
	{0xA2,1,{0x29}}, //0x2D              //VP247
	...
	{0xA7,1,{0x1E}}, // 0x21             //VP203
	
	{0xA8,1,{0x8B}}, //0x92            //VP175
	
	{0xA9,1,{0x1D}},//0x1C              //VP144
	
	{0xAA,1,{0x2A}}, //0x2A              //VP111
	...
	{0xAF,1,{0x21}}, //0x24              //VP16
	
	{0xB0,1,{0x28}},               //VP12
	
	{0xB1,1,{0x49}},//0x48               //VP8
	...
	{0xC6,1,{0x1F}},//0x1B               //VN219
	
	{0xC7,1,{0x1E}},//0x1D               //VN203
	
	{0xC8,1,{0x8B}},//0x88               //VN175
	...
	{0xCC,1,{0x1A}},//0x1D               //VN52
	
	{0xCD,1,{0x1A}},//0x19               //VN36
	
	{0xCE,1,{0x4C}},//0x52               //VN24
	
	{0xCF,1,{0x24}},//0x22               //VN16
	
	{0xD0,1,{0x2A}},//0x2C               //VN12
...
LCM_DRIVER ili9881c_dsi_vdo_hd720_dj_ips_b50506_lcm_drv = 
{
	.name			= "ili9881c_dsi_vdo_hd720_dj_ips_b50506",
