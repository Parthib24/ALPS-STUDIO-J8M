...
#define MIN_VOLTAGE (1400)	
#define MAX_VOLTAGE (1900)	
...
{0x56,01,{0x00}},  // OTP VCOM RE-WRITE
...
LCM_DRIVER ili9881c_dsi_vdo_hd720_hlt_hsd_ips_v52516_lcm_drv = 
{
	.name			= "ili9881c_dsi_vdo_hd720_hlt_hsd_ips_v52516",
