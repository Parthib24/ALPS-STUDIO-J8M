...
#define MIN_VOLTAGE (1300)	//++++rgk bug-id:no modify by yangjuwei 20140401
#define MAX_VOLTAGE (1500)	//++++rgk bug-id:no modify by yangjuwei 20140401
...
LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_d517g_lcm_drv = 
{
	.name			= "ili9806e_dsi_vdo_hlt_fwvga_d517g",
