...
//-------------------- gamma -----------------------------------------//
	{0x00,1,{0x00}},    ///////////////////////////////////////////////                                                                                                                                                       
	{0xE1,16,{0x12,0x1d,0x27,0x35,0x40,0x5c,0x5a,0x70,0x85,0x71,0x79,0x62,0x49,0x37,0x29,0x12}}, 

	{0x00,1,{0x00}},                                                                                                                                                           
	{0xE2,16,{0x12,0x1d,0x27,0x35,0x40,0x5c,0x5a,0x70,0x85,0x71,0x79,0x62,0x49,0x37,0x29,0x12}},
...
{
	printk("***kernel lcm init chengzhou****start\n");
   	#ifdef BUILD_LK
...
//gpio_get_value(GPIO_READ_ID_PIN);//获取输入电平，你自己弄个变量保存一下。
  ...
  gpio_direction_output(lcm_gpio_enp, 0);//设为输出
	...
	#endif
	printk("***kernel lcm init chengzhou****end\n");
}
...
LCM_DRIVER ili9881c_dsi_vdo_hd720_ykl_hsd_ips_v52516_lcm_drv = 
{
	.name			= "ili9881c_dsi_vdo_hd720_ykl_hsd_ips_v52516",
	.set_util_funcs		= lcm_set_util_funcs,
	.get_params		= lcm_get_params,
	.init			= lcm_init,
    .suspend        = lcm_suspend,
    .resume         = lcm_resume,
    .compare_id     = rgk_lcm_compare_id,//lcm_compare_id,
