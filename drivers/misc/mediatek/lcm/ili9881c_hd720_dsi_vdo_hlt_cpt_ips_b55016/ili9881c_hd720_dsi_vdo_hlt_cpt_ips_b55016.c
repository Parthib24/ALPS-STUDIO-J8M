...
#define MIN_VOLTAGE (1100)	//++++rgk bug-id:no modify by yangjuwei 20140401
#define MAX_VOLTAGE (1300)	//++++rgk bug-id:no modify by yangjuwei 20140401
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_hlt_cpt_ips_b55016_lcm_drv = 
{
	.name			= "ili9881c_hd720_dsi_vdo_hlt_cpt_ips_b55016",
