...
/**********************************************************
  ...
  *********************************************************/
//CON0----------------------------------------------------
extern void bq24157_set_tmr_rst(u32 val);
extern u32 bq24157_get_otg_status(void);
extern void bq24157_set_en_stat(u32 val);
extern u32 bq24157_get_chip_status(void);
extern u32 bq24157_get_boost_status(void);
extern u32 bq24157_get_fault_status(void);
//CON1----------------------------------------------------
extern void bq24157_set_input_charging_current(u32 val);
extern void bq24157_set_v_low(u32 val);
extern void bq24157_set_te(u32 val);
extern void bq24157_set_ce(u32 val);
extern void bq24157_set_hz_mode(u32 val);
extern void bq24157_set_opa_mode(u32 val);
//CON2----------------------------------------------------
extern void bq24157_set_oreg(u32 val);
extern void bq24157_set_otg_pl(u32 val);
extern void bq24157_set_otg_en(u32 val);
//CON3----------------------------------------------------
extern u32 bq24157_get_vender_code(void);
extern u32 bq24157_get_pn(void);
extern u32 bq24157_get_revision(void);
//CON4----------------------------------------------------
extern void bq24157_set_reset(u32 val);
extern void bq24157_set_iocharge(u32 val);
extern void bq24157_set_iterm(u32 val);
//CON5----------------------------------------------------
extern void bq24157_set_dis_vreg(u32 val);
extern void bq24157_set_io_level(u32 val);
extern u32 bq24157_get_sp_status(void);
extern u32 bq24157_get_en_level(void);
extern void bq24157_set_vsp(u32 val);
//CON6----------------------------------------------------
extern void bq24157_set_i_safe(u32 val);
extern void bq24157_set_v_safe(u32 val);
//---------------------------------------------------------
extern void bq24157_dump_register(void);
extern u32 bq24157_config_interface_liao (u8 RegNum, u8 val);

extern u32 bq24157_read_interface (u8 RegNum, u8 *val, u8 MASK, u8 SHIFT);
extern u32 bq24157_config_interface (u8 RegNum, u8 val, u8 MASK, u8 SHIFT);
