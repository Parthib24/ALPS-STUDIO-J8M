...
#if 0//rl add
//#define GPIO_SWCHARGER_EN_PIN         (GPIO4 | 0x80000000)
#define GPIO_SWCHARGER_EN_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_SWCHARGER_EN_PIN         (4)//rl add
#endif 
 // ============================================================ //
 //global variable
 // ============================================================ //
...
{
	CHARGE_CURRENT_450_00_MA,   CHARGE_CURRENT_600_00_MA,	CHARGE_CURRENT_750_00_MA, CHARGE_CURRENT_850_00_MA,
...
static void hw_bc11_done(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	printk("ttt charging_hw_init begin\n");
   ...
   // #if defined(CONFIG_QC_BQ24157_SUPPORT) 
	//fan5405_reg_config_interface(0x06,0x77); // ISAFE = 1250mA, VSAFE = 4.34V
	fan5405_reg_config_interface(0x06,0x7a); // ISAFE = 1250mA, VSAFE = 4.40V
	#else
    fan5405_reg_config_interface(0x06,0x5a); // ISAFE = 1250mA, VSAFE = 4.40V
    #endif
	//modify voltage -----------------------hlm
	...
	fan5405_reg_config_interface(0x05,0x04);//0x04 for presimi  // 0x03
	if ( !charging_init_flag ) {   
		//fan5405_reg_config_interface(0x04,0x1A); //146mA
		fan5405_reg_config_interface(0x04,0x7A); //146+495+247+680mA
		charging_init_flag = KAL_TRUE;
	}      
	    fan5405_dump_register();
		printk("tttt fan5405 charging_hw_init \n");
	#else
	...
	if ( !charging_init_flag ) {   
		fan5405_reg_config_interface(0x04,0x74); //146mA
		charging_init_flag = KAL_TRUE;
	}     
	//fan5405_reg_config_interface(0x04,0x74);
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
	...
	fan5405_set_oreg(register_value); 
	 fan5405_dump_register();
	 printk("tttt charging_set_cv_voltage\n");
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	else
	{
		...
		//fan5405_read_register(4);
		printk("tttt charging_set_current register_value=0x%x \n",register_value);
	}
	return status;
 } 	
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
    ...
    if(*(kal_uint32 *)data > CHARGE_CURRENT_800_00_MA)
    {
        register_value = 0x3;
    }
    else
    ...
    printk("tttt charging_set_input_current register_value=0x%x \n",register_value);
