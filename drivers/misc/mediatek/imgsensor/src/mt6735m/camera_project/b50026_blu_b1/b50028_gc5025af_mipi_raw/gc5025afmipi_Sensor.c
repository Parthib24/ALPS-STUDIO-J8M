...
#include "gc5025afmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "B50028_GC5025AF_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = B50028_GC5025AF_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	//printk("@@fanfan  B50028_gc5025af get_imgsensor_id() gpio_get_value(42) = %d \n", gpio_get_value(42));
    	...
    	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        	...
        	do {
            	*sensor_id = return_sensor_id()+1;
				//printk(" B50028_gc5025 get_imgsensor_id() sensor_id = %d \n", *sensor_id);
            	if (*sensor_id == imgsensor_info.sensor_id) {
                	LOG_INF("  B50028_gc5025af i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                	printk("  B50028_gc5025af i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                	return ERROR_NONE;
            	}
...
UINT32 B50028_GC5025AF_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("ww_GC5025MIPI_RAW_SensorInit");
