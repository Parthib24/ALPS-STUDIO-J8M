...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = B50028_SP5509_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	
	.checksum_value = 0x7d58145a,		//checksum value for Camera Auto Test
  ...
  .custom5 = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,//sensor output first pixel color Gb B
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
	LOG_INF(" B50028_SP5509 get_imgsensor_id() sensor_id = %d \n",*sensor_id); 
		if(main_sub != 1)
	{
...
UINT32 B50028_SP5509_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
