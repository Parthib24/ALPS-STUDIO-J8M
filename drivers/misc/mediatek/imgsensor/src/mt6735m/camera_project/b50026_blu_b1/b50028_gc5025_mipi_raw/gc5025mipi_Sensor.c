...
#define PFX "B50028_GC5025_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = B50028_GC5025_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
       ...
       .hs_video = {
        ...
        .max_frame_length = 0x2710,//max framelength by sensor register's limitation 0x1388
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	//printk("@@fanfan  B50028_gc5025 get_imgsensor_id() gpio_get_value(42) = %d \n", gpio_get_value(42));
...
UINT32 B50028_GC5025_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
