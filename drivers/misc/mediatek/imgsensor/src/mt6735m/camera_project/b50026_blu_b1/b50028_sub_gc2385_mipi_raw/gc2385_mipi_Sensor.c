...
#define PFX "B50028_GC2385_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = B50028_SUB_GC2385_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			//printk(" B50028_GC2385 get_imgsensor_id() sensor_id = %d \n", *sensor_id);
...
UINT32 B50028_SUB_GC2385_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
