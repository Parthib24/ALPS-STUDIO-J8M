...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = B50028_SUB_SP250A_SENSOR_ID,
 ...
 static u32 strtol(const char *nptr, u8 base)
{
 ...
 static u32 SP250aMIPI_Initialize_from_T_Flash(void)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF(" B50028_SP250A get_imgsensor_id() sensor_id = %d \n",*sensor_id); 
...
UINT32 B50028_SUB_SP250A_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
